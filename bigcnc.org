...
* [2018-07-22]
** problem: limits should reach both ESS and drives, but drives expect 24V and ESS expects 5V.
*** solution 1: limits work on 24V, hand made adapter board translates to 5V for ESS. current suggestion calls for transistor, 3 resistors and zener per limit sw.
*** solution 2: limits work on 5V, relays translate it to 24V. requires 1 relay per limit sw. 
*** solution 3: look for off the shelf level translator board.
